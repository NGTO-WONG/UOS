...
namespace AEG.FSR
{
    ...
    /// </summary>
    public class FSR2_BIRP : FSR2_BASE
    {
        // Commandbuffers
        ...
        private readonly Fsr2.DispatchDescription m_dispatchDescription = new Fsr2.DispatchDescription();
        private readonly Fsr2.GenerateReactiveDescription m_genReactiveDescription = new Fsr2.GenerateReactiveDescription();
        private IFsr2Callbacks Callbacks { get; set; } = new Fsr2CallbacksBase();
        private Fsr2Context m_context;
        ...
        private void SetupResolution() {
            ...
            Fsr2.InitializationFlags flags = Fsr2.InitializationFlags.EnableAutoExposure;
            ...
            m_context = Fsr2.CreateContext(new Vector2Int(m_displayWidth, m_displayHeight), new Vector2Int((int)(m_displayWidth), (int)(m_displayHeight)), Callbacks, flags);
