...
namespace AEG.FSR
{
    ...
    public abstract class FSR2_BASE : MonoBehaviour
    {
        public void SetQuality(int t)
        {
            var value= Mathf.Clamp(t, 0, 5);
            FSRQuality = (FSR_Quality)value;
        }
        ...
        public Fsr2.GenerateReactiveFlags reactiveFlags = Fsr2.GenerateReactiveFlags.ApplyTonemap | Fsr2.GenerateReactiveFlags.ApplyThreshold | Fsr2.GenerateReactiveFlags.UseComponentsMax;
