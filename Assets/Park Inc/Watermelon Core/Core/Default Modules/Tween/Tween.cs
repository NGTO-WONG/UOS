...
namespace Watermelon
{
    ...
    public class Tween : MonoBehaviour
    {
        ...
        /// Interpolate float value
        /// </summary>
        public static TweenCase DoFloat(float startValue, float resultValue, float time, TweenCaseFloat.TweenFloatCallback callback, bool unscaledTime = false, TweenType tweenType = TweenType.Update)
        {
            return new TweenCaseFloat(startValue, resultValue, callback).SetTime(time).SetUnscaledMode(unscaledTime).SetType(tweenType).StartTween();
        }
