...
{
    public class BattleEnemy_Melee: BattleBaseCharacter
    {
        ...
        public override UniTask Attack(BattleBaseCharacter targetCharacter)
        {
            return base.Attack(targetCharacter);
        }
