...
namespace Watermelon
{
    ...
    public class AdsDataEditor : WatermelonEditor
    {
        ...
        private readonly AdsContainer[] adsContainers = new AdsContainer[]
        {
            ...
            new IronSourceContainer("Iron Source", "ironSourceContainer", "MODULE_IRONSOURCE")
        };
        ...
        private class UnityAdsContainer : AdsContainer
        {
            ...
            protected override void SpecialButtons()
            {
                ...
                EditorGUILayout.HelpBox("Tested with Advertisement v3.7.5", MessageType.Info);
            }
        }
        ...
        {
            public IronSourceContainer(string containerName, string propertyName, string defineName) : base(containerName, propertyName, defineName)
            {
            }
